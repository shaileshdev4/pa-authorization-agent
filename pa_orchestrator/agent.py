...
root_agent = Agent(
    ...
    instruction=(
        ...
        "IMPORTANT: If the user message is a follow-up or refinement of a prior PA request "
        "(contains phrases like 'update', 'try again', 'where is packet', 'please update'), "
        "call pa_authorization_agent ONE time with the COMPLETE original patient context. "
        "Do not call pa_authorization_agent multiple times for the same patient in one session.\n\n"
