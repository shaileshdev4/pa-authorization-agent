...
root_agent = Agent(
    ...
    instruction=(
        ...
        "  - condition: 'Acute Lymphoblastic Leukemia' — hardcode this exact string, "
        "    do not modify it, do not append any other text to it\n"
        "  - patient_age: 43\n"
        "  - patient_sex: 'female'\n"
        ...
        "    Do not summarize or restructure it. Pass the entire string as-is.\n"
        "  - raw_clinical_context: pass the original user message text\n"
        "  - physician_name, institution, physician_npi: extract from the GetPatientData result\n\n"
